...
module SwapAdmin::TokenSwapGov {
    ...
    #[test] public fun test_time_linear_withdraw() {
        ...
        let farm_can_withdraw_amount = if (elapsed_time >= farm_total_timestamp) {
            ...
            let second_release = SafeMath::mul_div( calculate_amount_from_percent(GOV_PERCENT_FARM - GOV_PERCENT_FARM_GENESIS ) , (scaling_factor as u128) , (farm_total_timestamp as u128));
        ...
        let syrup_can_withdraw_amount = if (elapsed_time >= syrup_total_timestamp) {
            ...
            let second_release = SafeMath::mul_div( calculate_amount_from_percent(GOV_PERCENT_SYRUP - GOV_PERCENT_SYRUP_GENESIS ) , (scaling_factor as u128) , (syrup_total_timestamp as u128));
            (( now_timestamp - start_timestamp  ) as u128) * second_release
        };
        ...
        let community_can_withdraw_amount = if (elapsed_time >= community_total_timestamp) {
            ...
            let second_release = SafeMath::mul_div( calculate_amount_from_percent(GOV_PERCENT_COMMUNITY - GOV_PERCENT_COMMUNITY_GENESIS ) , (scaling_factor as u128) , (community_total_timestamp as u128));
            (( now_timestamp - start_timestamp  ) as u128) * second_release
        };
        ...
        let developer_fund_can_withdraw_amount = if (elapsed_time >= developer_fund_total_timestamp) {
            ...
            let second_release = SafeMath::mul_div( calculate_amount_from_percent(GOV_PERCENT_DEVELOPER_FUND ) , (scaling_factor as u128) , (developer_fund_total_timestamp as u128));
            (( now_timestamp - start_timestamp  ) as u128) * second_release
        };
    ...
    //Initialize the economic model of linear release
     public fun linear_initialize(account: &signer) acquires GovTreasury {
        ...
        move_to(account, GovTreasuryEvent{
            withdraw_linearGovTreasury_event_handler: account::new_event_handle<LinearGovTreasuryWithdrawEvent<PoolTypeFarmPool>>(account),
            withdraw_genesisGovTreasury_event_handler: account::new_event_handle<GenesisGovTreasuryWithdrawEvent<PoolTypeFarmPool>>(account),
        });
        ...
        move_to(account, GovTreasuryEvent{
            withdraw_linearGovTreasury_event_handler: account::new_event_handle<LinearGovTreasuryWithdrawEvent<PoolTypeDeveloperFund>>(account),
        ...
        move_to(account, GovTreasuryEvent{
            withdraw_linearGovTreasury_event_handler: account::new_event_handle<LinearGovTreasuryWithdrawEvent<PoolTypeIDO>>(account),
            withdraw_genesisGovTreasury_event_handler: account::new_event_handle<GenesisGovTreasuryWithdrawEvent<PoolTypeIDO>>(account),
        });
        ...
        move_to(account, GovTreasuryEvent{
            withdraw_linearGovTreasury_event_handler: account::new_event_handle<LinearGovTreasuryWithdrawEvent<PoolTypeProtocolTreasury>>(account),
            withdraw_genesisGovTreasury_event_handler: account::new_event_handle<GenesisGovTreasuryWithdrawEvent<PoolTypeProtocolTreasury>>(account),
        });
