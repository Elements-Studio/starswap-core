    ...
    public fun current_cumulative_prices_v2<X, Y>(): (U256, U256, u64) {
        ...
        if (last_block_timestamp != block_timestamp) {
            ...
            if (x_reserve !=0 && y_reserve != 0){
                ...
                // counterfactual
                let new_price_x_cumulative = U256Wrapper::mul(FixedPoint64::to_u256(FixedPoint64::div(FixedPoint64::encode(y_reserve), x_reserve)), U256Wrapper::from_u64(time_elapsed));
                let new_price_y_cumulative = U256Wrapper::mul(FixedPoint64::to_u256(FixedPoint64::div(FixedPoint64::encode(x_reserve), y_reserve)), U256Wrapper::from_u64(time_elapsed));
