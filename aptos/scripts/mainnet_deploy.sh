...
### 编译依赖项目usdt-dep
#aptos move compile  --package-dir ./usdt-dep  --named-addresses UsdtIssuer=mainnet-admin

### 部署依赖项目usdt-dep
#aptos move publish  --package-dir ./usdt-dep  --named-addresses UsdtIssuer=mainnet-admin --profile mainnet-admin  --included-artifacts sparse --assume-yes
...
### XUSDT初始化
#aptos move run --function-id 'mainnet-admin::XUSDT::init' --profile mainnet-admin --assume-yes
...
### 管理员创建swap交易对
#aptos move run --function-id 'mainnet-admin::TokenSwapScripts::register_swap_pair' --type-args 0xf0b07b5181ce76e447632cdff90525c0411fd15eb61df7da4e835cf88dc05f5b::STAR::STAR 0xf22bede237a07e121b56d91a491eb7bcdfd1f5907926a9e58338f964a01b17fa::asset::USDT  --profile mainnet-admin --assume-yes


##  准备测试Token

 ###提取STAR
aptos move run --function-id 'mainnet-admin::TokenSwapGovScript::dispatch' --type-args 0xf0b07b5181ce76e447632cdff90525c0411fd15eb61df7da4e835cf88dc05f5b::TokenSwapGovPoolType::PoolTypeCommunity --args address:0xf0b07b5181ce76e447632cdff90525c0411fd15eb61df7da4e835cf88dc05f5b u128:50000000000000  --profile mainnet-admin --assume-yes
...
#aptos move run --function-id 'mainnet-admin::TokenSwapScripts::add_liquidity' --type-args 0xf0b07b5181ce76e447632cdff90525c0411fd15eb61df7da4e835cf88dc05f5b::STAR::STAR 0xf22bede237a07e121b56d91a491eb7bcdfd1f5907926a9e58338f964a01b17fa::asset::USDT  --args  u128:30000000000000  u128:500000000  u128:5000  u128:5000  --profile mainnet-admin --assume-yes
...
### 管理员创建Farm池
#aptos move run --function-id 'mainnet-admin::TokenSwapFarmScript::add_farm_pool_v2' --type-args 0xf0b07b5181ce76e447632cdff90525c0411fd15eb61df7da4e835cf88dc05f5b::STAR::STAR 0xf22bede237a07e121b56d91a491eb7bcdfd1f5907926a9e58338f964a01b17fa::asset::USDT --args u128:30 --profile mainnet-admin --assume-yes

### 调整Farm池子倍率
#aptos move run --function-id 'mainnet-admin::TokenSwapFarmScript::set_farm_alloc_point' --type-args 0xf0b07b5181ce76e447632cdff90525c0411fd15eb61df7da4e835cf88dc05f5b::STAR::STAR 0xf22bede237a07e121b56d91a491eb7bcdfd1f5907926a9e58338f964a01b17fa::asset::USDT  --args u128:0 --profile mainnet-admin --assume-yes
...
### 调整Farm池子倍率
#aptos move run --function-id 'mainnet-admin::TokenSwapFarmScript::set_farm_alloc_point' --type-args 0xf0b07b5181ce76e447632cdff90525c0411fd15eb61df7da4e835cf88dc05f5b::STAR::STAR 0x1::aptos_coin::AptosCoin  --args u128:30 --profile mainnet-admin --assume-yes
...
### 测试账号接收token
#aptos move run --function-id 0xf0b07b5181ce76e447632cdff90525c0411fd15eb61df7da4e835cf88dc05f5b::CommonHelper::accept_token_entry --type-args 0xf0b07b5181ce76e447632cdff90525c0411fd15eb61df7da4e835cf88dc05f5b::STAR::STAR  --private-key {output.key.test}  --url https://mainnet.aptoslabs.com --assume-yes

### 给test account 转 STAR，单次转200个STAR
#aptos move run --function-id 0x1::coin::transfer --type-args 0xf0b07b5181ce76e447632cdff90525c0411fd15eb61df7da4e835cf88dc05f5b::STAR::STAR --args address:0xf0b07b5181ce76e447632cdff90525c0411fd15eb61df7da4e835cf88dc05f5b u64:200000000000 --profile mainnet-admin --assume-yes

### 触发一次swap交易
#aptos move run --function-id 'mainnet-admin::TokenSwapScripts::swap_exact_token_for_token' --type-args 0xf0b07b5181ce76e447632cdff90525c0411fd15eb61df7da4e835cf88dc05f5b::STAR::STAR 0xf22bede237a07e121b56d91a491eb7bcdfd1f5907926a9e58338f964a01b17fa::asset::USDT  --args u128:10000000000 u128:100 --private-key {output.key.test}  --url https://mainnet.aptoslabs.com --assume-yes
