...
aptos move run --function-id 'devnet-admin::UpgradeScripts::genesis_initialize_for_setup' --profile devnet-admin --assume-yes
sleep 5
...
##  准备测试Token
 ...
 ###提取STAR
#aptos move run --function-id 'devnet-admin::TokenSwapGovScript::dispatch' --type-args ${SWAP_ADMIN}::TokenSwapGovPoolType::PoolTypeCommunity --args address:0x9bf32e42c442ae2adbc87bc7923610621469bf183266364503a7a434fe9d50ca u128:50000000000000  --profile devnet-admin --assume-yes
...
### 管理员创建swap交易对
#aptos move run --function-id 'devnet-admin::TokenSwapScripts::register_swap_pair' --type-args ${SWAP_ADMIN}::STAR::STAR 0x1::aptos_coin::AptosCoin  --profile devnet-admin --assume-yes
#sleep 5

### 管理员添加代币对流动性（STAR:APT 约等于 400:1,，STAR-APT初始流动性(400,1)）
aptos move run --function-id 'devnet-admin::TokenSwapScripts::add_liquidity' --type-args ${SWAP_ADMIN}::STAR::STAR 0x1::aptos_coin::AptosCoin  --args  u128:400000000000  u128:100000000  u128:5000  u128:5000  --profile devnet-admin --assume-yes
sleep 5
...
### 调整Farm池子倍率
#aptos move run --function-id 'devnet-admin::TokenSwapFarmScript::set_farm_alloc_point' --type-args ${SWAP_ADMIN}::STAR::STAR 0x1::aptos_coin::AptosCoin  --args u128:30 --profile devnet-admin --assume-yes
...
### 管理员创建Syrup
#aptos move run --function-id 'devnet-admin::TokenSwapSyrupScript::add_pool_v2' --type-args ${SWAP_ADMIN}::STAR::STAR --args  u128:30  u64:0 --profile devnet-admin --assume-yes
#sleep 5


### 添加Syrup池子阶梯倍率
#### 100s
aptos move run --function-id 'devnet-admin::TokenSwapSyrupScript::put_stepwise_multiplier_with_token_type' --type-args ${SWAP_ADMIN}::STAR::STAR --args u64:100  u64:1 --profile devnet-admin --assume-yes
sleep 5

#### 1hour
aptos move run --function-id 'devnet-admin::TokenSwapSyrupScript::put_stepwise_multiplier_with_token_type' --type-args ${SWAP_ADMIN}::STAR::STAR --args u64:3600 u64:1 --profile devnet-admin --assume-yes
sleep 5

#### 7d
#aptos move run --function-id 'devnet-admin::TokenSwapSyrupScript::put_stepwise_multiplier_with_token_type' --type-args ${SWAP_ADMIN}::STAR::STAR --args u64:604800 u64:1 --profile devnet-admin --assume-yes
#sleep 5

#### 14d
#aptos move run --function-id 'devnet-admin::TokenSwapSyrupScript::put_stepwise_multiplier_with_token_type' --type-args ${SWAP_ADMIN}::STAR::STAR --args u64:1209600 u64:2 --profile devnet-admin --assume-yes
#sleep 5

#### 30d
#aptos move run --function-id 'devnet-admin::TokenSwapSyrupScript::put_stepwise_multiplier_with_token_type' --type-args ${SWAP_ADMIN}::STAR::STAR --args u64:2592000 u64:6 --profile devnet-admin --assume-yes
#sleep 5

#### 60d
#aptos move run --function-id 'devnet-admin::TokenSwapSyrupScript::put_stepwise_multiplier_with_token_type' --type-args ${SWAP_ADMIN}::STAR::STAR --args u64:5184000 u64:9 --profile devnet-admin --assume-yes
#sleep 5

#### 90d
#aptos move run --function-id 'devnet-admin::TokenSwapSyrupScript::put_stepwise_multiplier_with_token_type' --type-args ${SWAP_ADMIN}::STAR::STAR --args u64:7776000 u64:12 --profile devnet-admin --assume-yes
#sleep 5

### 验证

### 测试账号接收token
#aptos move run --function-id ${SWAP_ADMIN}::CommonHelper::accept_token_entry --type-args ${SWAP_ADMIN}::STAR::STAR  --private-key {output.key.test}  --url https://devnet.aptoslabs.com --assume-yes
...
### 质押流动性
aptos move run --function-id 'devnet-admin::TokenSwapFarmScript::stake' --type-args ${SWAP_ADMIN}::STAR::STAR 0x1::aptos_coin::AptosCoin  --args  u128:30622   --profile  devnet-admin --assume-yes

### 领取奖励
aptos move run --function-id 'devnet-admin::TokenSwapFarmScript::harvest' --type-args ${SWAP_ADMIN}::STAR::STAR 0x1::aptos_coin::AptosCoin  --args  u128:0   --profile  devnet-admin --assume-yes

### 取出Farm质押
aptos move run --function-id 'devnet-admin::TokenSwapFarmScript::unstake' --type-args ${SWAP_ADMIN}::STAR::STAR 0x1::aptos_coin::AptosCoin  --args  u128:3100   --profile  devnet-admin --assume-yes

### 质押Syrup
aptos move run --function-id 'devnet-admin::TokenSwapSyrupScript::stake' --type-args ${SWAP_ADMIN}::STAR::STAR  --args  u64:100 u128:100000000   --profile  devnet-admin --assume-yes
