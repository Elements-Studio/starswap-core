...
aptos move run --function-id 'devnet-admin::TokenSwapScripts::add_liquidity' --type-args 0x9bf32e42c442ae2adbc87bc7923610621469bf183266364503a7a434fe9d50ca::STAR::STAR 0x1::aptos_coin::AptosCoin  --args  u128:400000000000  u128:100000000  u128:5000  u128:5000  --profile devnet-admin --assume-yes
sleep 5
...
aptos move run --function-id 'devnet-admin::TokenSwapScripts::add_liquidity' --type-args  0x1::aptos_coin::AptosCoin 0x9bf32e42c442ae2adbc87bc7923610621469bf183266364503a7a434fe9d50ca::asset::USDT  --args  u128:100000000  u128:7000000  u128:5000  u128:5000  --profile devnet-admin --assume-yes
sleep 5
