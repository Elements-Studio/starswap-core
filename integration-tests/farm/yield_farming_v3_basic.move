...
script {
    ...
    fun swap_admin_register_token(account: signer) {
        Token::register_token<YieldFarmingWarpper::MockTokenType>(&account, 9u8);
    }
}
// check: EXECUTED
...
script {
    use StarcoinFramework::Account;
    use SwapAdmin::YieldFarmingWarpper::{MockTokenType};
...
script {
    ...
    use SwapAdmin::YieldFarmingWarpper::{MockTokenType, Self};
    ...
    fun admin_init_treasury(account: signer) {
        ...
        YieldFarmingWarpper::initialize_global_pool(&account, tresury, CommonHelper::pow_amount<MockTokenType>(1));
...
script {
    ...
    fun cindy_stake_1x_token_to_pool(signer: signer) {
        ...
        let stake_id = YieldFarmingWarpper::stake(&signer, CommonHelper::pow_amount<MockTokenType>(1), 1, 0);
...
script {
    ...
    fun cindy_query_token_amount(signer: signer) {
        ...
        assert!(expect_amount == CommonHelper::pow_amount<YieldFarmingWarpper::MockTokenType>(1), 10020);
    }
}
// check: EXECUTED
...
script {
    ...
    fun bob_harvest_mul1x_deadline60_after4sec_check_abort(signer: signer) {
        ...
        Account::deposit<YieldFarmingWarpper::MockTokenType>(Signer::address_of(&signer), token);
    }
}
...
script {
    ...
    fun bob_stake_2(signer: signer) {
        ...
        let stake_id = YieldFarmingWarpper::stake(&signer, CommonHelper::pow_amount<MockTokenType>(1), 2, 0);
...
script {
    ...
    fun bob_stake_3(signer: signer) {
        ...
        let stake_id = YieldFarmingWarpper::stake(&signer, CommonHelper::pow_amount<MockTokenType>(1), 3, 0);
...
script {
    ...
    fun bob_harvest_2(signer: signer) {
        ...
        Account::deposit<YieldFarmingWarpper::MockTokenType>(user_addr, token2);
        Debug::print(&amount2);
...
script {
    ...
    fun bob_unstake_all(signer: signer) {
        let (asset_1, token_1) = YieldFarmingWarpper::unstake(&signer, 1);
        let (asset_2, token_2) = YieldFarmingWarpper::unstake(&signer, 2);
        let (asset_3, token_3) = YieldFarmingWarpper::unstake(&signer, 3);
        let (asset_4, token_4) = YieldFarmingWarpper::unstake(&signer, 4);
        Debug::print(&asset_1);
        Debug::print(&token_1);
        Debug::print(&asset_2);
        Debug::print(&token_2);
...
script {
    ...
    fun swap_admin_reset_release_per_second(signer: signer) {
        YieldFarmingWarpper::reset_release_per_second(
            &signer, CommonHelper::pow_amount<YieldFarmingWarpper::MockTokenType>(10));
    }
}
// check: EXECUTED
...
script {
    ...
    fun alice_harvest_after_reset_relese_per_second(signer: signer) {
        ...
        Account::deposit<YieldFarmingWarpper::MockTokenType>(Signer::address_of(&signer), token);
        Debug::print(&amount);
        assert!(amount == CommonHelper::pow_amount<YieldFarmingWarpper::MockTokenType>(10), 10120);
    }
}
// check: EXECUTED