...
module alice::YieldFarmingWarpper {
    ...
    public fun stake(account: &signer, value: u128, multiplier: u64) : u64 acquires GovModfiyParamCapability {
    ...
    public fun unstake(account: &signer): (u128, u128) acquires HarvestWrapperCapability {
        let HarvestWrapperCapability {cap, stake_id: _} = move_from<HarvestWrapperCapability>(Signer::address_of(account));
