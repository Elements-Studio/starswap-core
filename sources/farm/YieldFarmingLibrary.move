...
module swap_admin::YieldFarmingLibrary {
    ...
    public fun calculate_harvest_index_weight_zero(
        ...
        let index_u256 =
            (harvest_index as u256) + BigExponential::mantissa(BigExponential::exp_direct_expand(addtion_index));
    ...
    public fun calculate_harvest_index(harvest_index: u128,
        ...
        let index_u256 = (harvest_index as u256) + addtion_harvest_index;
        BigExponential::to_safe_u128(index_u256)
    }
    ...
    public fun calculate_withdraw_amount(harvest_index: u128,
        ...
        let amount_u256 = (asset_weight as u256) * ((harvest_index - last_harvest_index) as u256);
