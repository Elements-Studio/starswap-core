...
module TokenSwapRouter {
    ...
    public fun compute_y_out<X: copy + drop + store, Y: copy + drop + store>(amount_x_in: u128,
                                                                             amount_y_out_min: u128): u128 {
    ...
    public fun swap_exact_token_for_token<X: copy + drop + store, Y: copy + drop + store>(
        ...
        // calculate actual y out
        let y_out = compute_y_out<X, Y>(amount_x_in, amount_y_out_min);
    ...
    public fun compute_x_in<X: copy + drop + store, Y: copy + drop + store>(amount_x_in_max: u128,
                                                                            amount_y_out: u128) : u128 {
    ...
    public fun swap_token_for_exact_token<X: copy + drop + store, Y: copy + drop + store>(
        ...
        // calculate actual x in
        let x_in = compute_x_in<X, Y>(amount_x_in_max, amount_y_out);
