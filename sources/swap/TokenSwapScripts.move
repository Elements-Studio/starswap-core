...
module swap_admin::TokenSwapScripts {
    ...
    public entry fun remove_liquidity<X, Y>(
        ...
        TokenSwapRouter::remove_liquidity<X, Y>(&signer, liquidity, amount_x_min, amount_y_min);
    }
    ...
    public entry fun set_swap_fee_operation_rate_v2<X, Y>(signer: signer, num: u64, denum: u64) {
